...
- [x] 화면의 너비가 1920px 보다 작아질 때, 최하단에 있는 “codei024”의 왼쪽 여백 200px과 SNS 아이콘들의 오른쪽 여백 200px을 유지하면서 가운데 있는 “Privacy Policy”, “FAQ” 요소와 각각 동일한 간격을 유지하며 가까워져야 합니다.
...
- [ ] 사용자의 브라우저 설정에 따라 기본 폰트 크기 설정이 변화함에 따라서 페이지의 요소 간 간격, 요소의 크기, fon
ize 등 모든 크기와 관련된 값이 크고 작아지도록 설정해 주세요.
공통
...
![image](../img/sprint_misson1.png)

## 멘토에게

- 커밋메시지를 알맞게 썻는지 궁금합니다.  커밋메시지에대한 조언부탁드리겠습니다.
- 코드가 너무 더러운거같습니다 깔끔하게 쓰고싶은데 잘안되네요.. 저번멘토링시간때도 말했지만 한번더 조언부탁드리겠습니다.
